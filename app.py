...
THRESHOLD_MAX_ACC_FALL_SCORE = 19.0  # Increased from 15.0
THRESHOLD_MIN_ACC_FALL_SCORE = 2.0   # Decreased from 3.0 (stricter free-fall)
THRESHOLD_ACC_DIFF_FALL_SCORE = 11.0 # Increased from 8.0
THRESHOLD_MAX_GYRO_FALL_SCORE = 4.5  # Increased from 3.0 (Now used more strictly)
